...
function About() {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center">
            ...
            <motion.a href="/Kentaro_Lim_Resume.pdf" target="_blank" className="text-lg bg-[#77DD77] rounded-3xl px-4 py-1 mt-10" whileTap={{scale:0.95}} whileHover={{scale:1.05}} >See my resume</motion.a>
        </section>
    )
}
